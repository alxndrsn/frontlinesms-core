...
public interface IInboundMessageNotification
{
	 ...
	 *            The message type.
	 * @param memLoc
	 *            The message memory location identifier where the message is
	 *            stored.
	 * @param memIndex
	 *            The memory index where the message is stored.
	 */
	void process(final String gtwId, final MessageTypes msgType, final String memLoc, final int memIndex);
}
