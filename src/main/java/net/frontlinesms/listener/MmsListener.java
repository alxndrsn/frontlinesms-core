...
public interface MmsListener {
	 ...
	 */
	public void incomingMessageEvent(MmsService receiver, CIncomingMessage incomingMessage);
	 ...
	 */
	public void outgoingMessageEvent(MmsService sender, FrontlineMessage outgoingMessage);
	 ...
	 */
	public void mmsDeviceEvent(MmsService activeService, MmsServiceStatus mmsDeviceStatus);
