 ...
 * @author Alex
 */
public class IncomingSmsProcessor extends Thread {
	...
	private static final Logger LOG = FrontlineUtils.getLogger(IncomingSmsProcessor.class);
...
//> DATA ACCESS OBJECTS
	...
	/** Create a new {@link IncomingSmsProcessor}, and initialise properties. */
	public IncomingSmsProcessor(FrontlineSMS frontline) {
...
/** Empty interface implemented by items which are put in the {@link IncomingSmsProcessor}'s queue. */
...
/**
 * Queuing an instance of this class will kill the {@link IncomingSmsProcessor}.
 * @author Alex
 */
